...
Sw3NtQuerySystemInformation PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 05B0E63A5h        ; Load function hash into ECX.
...
Sw3NtCreateSection PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 0FAEE3DBEh        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtMapViewOfSection PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 0868EA41Bh        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtUnmapViewOfSection PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 0094609A9h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtClose PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 00054FD0Dh        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtCreateThreadEx PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 0C21E0C68h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtWaitForSingleObject PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 08AA4DB89h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtDelayExecution PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 00A92204Fh        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtAllocateVirtualMemory PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 0C064D4CAh        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtWriteVirtualMemory PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 0198D2B27h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtProtectVirtualMemory PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 0D24BE2F2h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtFreeVirtualMemory PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 03FAD110Bh        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtQueueApcThread PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 0A695258Ah        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtOpenProcess PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 0FC29DDB5h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtOpenSection PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 088AC6CB7h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtResumeThread PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 02483E229h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtCreateUserProcess PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 0871D8886h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
...
Sw3NtReadVirtualMemory PROC
	...
	mov [rsp+32], r9
	sub rsp, 28h
	mov ecx, 0359D4373h        ; Load function hash into ECX.
	call SW3_GetSyscallNumber              ; Resolve function hash into syscall number.
	add rsp, 28h
	mov rcx, [rsp+8]                      ; Restore registers.
	mov rdx, [rsp+16]
